...
/*******************************************[ USER LIBRARY : TRIM2DK.C  ]*****
 ...
 void trim2dk (int feblk,int numel, int ndof, int nudim, int *id, int *side_nodes,
			             int xnsn, int *elm_sides, double *xyz, int *mat, double *prop,
			             int numpr, double *sg, int *maxa, int *lm, double *sv, double *Gij,
			             double *Kij, double *diag);
