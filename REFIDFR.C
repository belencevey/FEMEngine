...
/*******************************************[ USER LIBRARY : REFID.C    ]*****
 ...
 void refidfr (int ecode, int curlev, int *acnumel, int *numel, int *nodes,
               int *rnumel, int *FRnumel, int **velm,  int xndof, int nudim,
               int xnsn, double **xyz, int **elm_sides , int **elm_nodes,
               int **elm_vlev,int **parent_elm, int *sides    , int *Bsides,
               int *BFRsides, int *FRsides, int *PRsides, int **vside  ,
               int **eside, int **bside, int **tside, int **ssside,
               int **side_nodes, int **side_vlev,
               int **parent_side, int *side_bc, double **uold,
               int *mat       , double *prop  , int xnumpr,
               int *side_mat, int **relm    , double **error,
               double  **Fn   , double  **Fs,
                       ...
                       double **bn_qn, double **bn_qs, double **bs_cs, double **bs_sn)
