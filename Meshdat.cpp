...
/*******************************************[ USER LIBRARY : MESHDAT.C ]******
 ...
 #****************************************************************************/
   ...
   void  meshdat(std::ifstream &fpi      , int numnp     , int numel,
 ...
 /*
 void  meshdat(FILE *fpi      , int numnp     , int numel,
                       int sides      , int bsides    , int nudim,
                       int ecode      , double *xyz   , double *xyzc,
                       int *id        , int xndof     , int xnbdof,
					   int xnsn       , int xnes      ,
...
____________________________________________________________________________*/
  ...
  void coord   (std::ifstream &fpi, int, int, double*);
  /*void nodebc  (FILE* fpi, int ecode, int numnp, int bsides, int xndof, int *id,
                int *idb, double *bn_cs, double *bn_sn);*/
  void nodebc  (std::ifstream &fpi, int ecode, int numnp, int bsides, int xndof, int *id,
                int *idb, double *bn_cs, double *bn_sn);
  /*void sideinc (FILE*, int, int, int, int*, int*, int);*/
  void sideinc (std::ifstream &fpi, int, int, int, int*, int*, int);
  /*void sidebc  (FILE* fpi, int bsides, int xnsn, int xnbdof, int nudim,
                ...
                int numcurv);*/
  void sidebc  (std::ifstream &fpi, int bsides, int xnsn, int xnbdof, int nudim,
                int *side_nodes,
                int *side_bc, double *xyz, double *xyzc, double *bs_cs,
                double *bs_sn, double *bn_nlength, double *bn_slength,
                int numcurv);
  /*void matprop (FILE*, int, int, double*, int);*/
  void matprop (std::ifstream &fpi, int, int, double*, int);
  /*void elminc  (FILE*, int, int, int, int, int*, int, int*, int*, int);*/
  void elminc  (std::ifstream &fpi, int, int, int, int, int*, int, int*, int*, int);
...
/*******************************************[ USER LIBRARY : MESHDAT.C ]******
 ...
 #****************************************************************************/
  ...
  void coord (std::ifstream &fpi, int  numnp, int nudim, double *xyz)
	  ...
	  if (node>numnp || node<0)
		 {
			 ...
			 */
			 ...
			 std::cout<<"ILLEGAL NODE NUMBER IN NODAL COORDINATES";
			 std::cout<<std::endl;
			 exit(1);
		 }
...
/*******************************************[ USER LIBRARY : MESHDAT.C ]******
 ...
 #****************************************************************************/
  ...
  void nodebc (std::ifstream &fpi, int ecode, int numnp, int bnodes, int xndof, int *id, int *idb, double *bn_cs, double *bn_sn)
		...
		if (node>numnp || node<0)
		  {
			 ...
			 */
			 std::cout<<std::endl;
			 std::cout<<"FATAL ERROR: ";
			 std::cout<<"ILLEGAL NODE NUMBER IN NODAL BOUNDARY CONDITIONS";
             std::cout<<std::endl;
     ...
     fpi>>angle;
		if (angle>360. || angle<-360.0)
        {
			 ...
			 */
			 std::cout<<std::endl;
			 std::cout<<"FATAL ERROR: ";
			 std::cout<<"OUT OF RANGE NODAL ANGLE [-360, 360]";
			 std::cout<<std::endl;
			 exit(1);
        }
			  ...
			  if (rdof>1 || rdof<0)
				 {
					...
					*/
					std::cout<<std::endl;
					std::cout<<"FATAL ERROR: ";
					std::cout<<"ILLEGAL RESTRAINT IN NODAL BOUNDARY CONDITIONS";
					std::cout<<std::endl;
					exit(1);
				 }
...
/*******************************************[ USER LIBRARY : MESHDAT.C ]******
 ...
 #****************************************************************************/
  ...
  void sideinc (std::ifstream &fpi, int numnp, int sides, int xnsn, int *side_nodes, int *side_vlev, int ecode)
		...
		if (side>sides || side<0)
		  {
			 ...
			 */
			 std::cout<<std::endl;
			 std::cout<<"FATAL ERROR: ";
			 std::cout<<"ILLEGAL SIDE NUMBER IN SIDE INCIDENCES";
			 std::cout<<std::endl;
			 exit(3);
		  }
			  ...
			  if (node>numnp)
				 {
					...
					*/
                    std::cout<<std::endl;
					std::cout<<"FATAL ERROR: ";
					std::cout<<"ILLEGAL NODE NUMBER IN SIDE INCIDENCES";
					std::cout<<std::endl;
					exit(1);
				 }
...
void sidebc (std::ifstream &fpi, int bsides, int xnsn, int xnbdof, int nudim, int *side_nodes, int *side_bc,
               double *xyz, double *xyzc, double *bs_cs, double *bs_sn, double *bn_nlength, double *bn_slength, int numcurv)
/*____________________________________________________________________________
			  ...
			  if (rdof>1 || rdof<0)
				 {
					...
					*/
					std::cout<<std::endl;
					std::cout<<"FATAL ERROR: ";
					std::cout<<"ILLEGAL RESTRAINT IN SIDE BOUNDARY CONDITIONS";
					std::cout<<std::endl;
					exit(1);
				 }
...
____________________________________________________________________________*/
		...
		if (side>bsides || side<0)
        {
		  ...
		  */
		  std::cout<<std::endl;
		  std::cout<<"FATAL ERROR: ";
		  std::cout<<"ILLEGAL BOUNDARY SIDE NUMBER IN CONTROL POINT COORDINATES";
		  std::cout<<std::endl;
...
/*******************************************[ USER LIBRARY : MESHDAT.C ]******
 ...
 #***************************************************************************/
  ...
  void matprop (std::ifstream &fpi, int ecode, int numat, double *prop, int xnumpr)
...
/*******************************************[ USER LIBRARY : MESHDAT.C ]******
 ...
 #***************************************************************************/
  ...
  void elminc (std::ifstream &fpi, int ecode, int numel, int sides, int bsides, int *side_mat,
               int numat, int *mat, int *elm_sides, int xnes)
		...
		if (elm>numel || elm<0)
		  {
			 ...
			 */
			 std::cout<<"\n";
			 std::cout<<"FATAL ERROR: ";
			 std::cout<<"ILLEGAL ELEMENT NUMBER IN ELEMENT INCIDENCES";
			 std::cout<<"\n";
			 exit(2);
		  }
		...
		if (matnb<1 || matnb>numat)
		  {
			 ...
			 */
		     std::cout<<std::endl;
			 std::cout<<"FATAL ERROR: ";
			 std::cout<<"ILLEGAL ELEMENT MATERIAL NUMBER";
		     std::cout<<std::endl;
			 exit(2);
		  }
			  ...
			  if (abs(side)>sides || side==0)
				 {
					...
					*/
					std::cout<<std::endl;
					std::cout<<"FATAL ERROR: ";
					std::cout<<"ILLEGAL SIDE NUMBER IN ELEMENT INCIDENCES";
					std::cout<<std::endl;
					exit(1);
				 }
