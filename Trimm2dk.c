...
/*******************************************[ USER LIBRARY : TRIM2DK.C  ]*****
 ...
 void trimm2dbs (int bsides     , int ndof, int nudim  , int *id,
                 int *side_nodes, int *side_bc, int xnsn, double *xyz,
                 int *side_mat, int *mat, double *prop, int numpr ,
...
/*******************************************[ USER LIBRARY : TRIM2DK.C  ]*****
 ...
 void trimm2dis (int sides, int bsides     , int ndof,
                 int nudim  , int *id      , int *side_nodes, int *side_bc,
                 int xnsn, double *xyz, int *side_mat, int *mat, double *prop,
                 int numpr , double *sg, int *maxa, int *lm,
                 double *sv)
