...
/*******************************************[ USER LIBRARY : SKYLINE.C ]******
 ...
 #****************************************************************************/
  ...
  void expandv2D (double *dn, double *u, int *id, int numnp, int xndof, int *idb,
...
/*******************************************[ USER LIBRARY : SKYLINE.C ]******
 ...
 #****************************************************************************/
  ...
  void compressv2D (double *dn, double *u, int *id, int numnp, int xndof, int *idb,
                    double *bn_cs, double *bn_sn)
...
/*******************************************[ USER LIBRARY : SKYLINE.C ]******
 ...
 void  profile(int neq, int numel, int sides, int bsides,
