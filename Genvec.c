...
/*******************************************[ USER LIBRARY : GENVEC.C  ]******
 ...
 void sideload (int  ecode, int bsides, int xdf, int xndof,int  xnsn,
                int *side_nodes, double **side_loads, double *bs_Fs,
                double *bs_Fn, double *xyz, double *f, int *idb,
                double *bn_cs, double *bn_sn, double *bs_cs, double *bs_sn,
...
/*******************************************[ USER LIBRARY : GENVEC.C  ]******
 ...
 void mlsideload (int ecode, int *nodes, int *Bsides, int *BFRsides, int xdf,
                  int xndof, int xnsn, int **bside, int **side_nodes,
                  int **side_vlev, double **side_loads, int **parent_side,
                  int curlev, double **xyz, double **f, double **bs_cs,
                  double **bs_sn)
