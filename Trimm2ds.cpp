...
/*____________________________________________________________________________
						       ...
						       STRESSES ON SIDE L1 (PLANE STRAIN)
____________________________________________________________________________*/
...
/*____________________________________________________________________________
						       ...
						       STRESSES ON SIDE L2 (PLANE STRAIN)
____________________________________________________________________________*/
...
/*____________________________________________________________________________
						       ...
						       STRESSES ON SIDE L3 (PLANE STRAIN)
____________________________________________________________________________*/
...
/*
  ...
  fprintf (fpo,"%+14.8e ", error[velm[ie]]/errm);
	 ...
	 */
	 ...
	 fpo<<acnodes[lv1]+n1 << acnodes[lv2]+n2 << acnodes[lv3]+n3<<"\n";
	 fpo<<Sx1<<" "<<Sx2<<" "<<Sx3 << "\n";
	 fpo<<Sy1<<" "<<Sy2<<" "<<Sy3 << "\n";
	 fpo<<Sxy1<<" "<<Sxy2<<" "<<Sxy3 << "\n";
     fpo<<error[velm[ie]]/errm;
	 fpo<<"\n";
...
____________________________________________________________________________*/
  ...
  */
  fGiD<<ie<<" "<<SxL1<<" "<<SyL1<<" "<<SxyL1 << "\n";
  fGiD<<SxL2<<" "<<SyL2<<" "<<SxyL2 << "\n";
  fGiD<<SxL3<<" "<<SyL3<<" "<<SxyL3 << "\n";
